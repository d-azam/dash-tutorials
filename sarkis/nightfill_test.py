...
result_email_body = "The total time required to complete the night fill work is <b> {{ ti.xcom_pull(task_ids='night_fill_time_calc') }} </b> minutes"
...
night_fill_data >> export_night_fill_data_to_gcs >> night_fill_time_calc >> send_email_result
